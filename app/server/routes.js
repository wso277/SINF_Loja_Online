...
exports.listen = function (app) {
    ...
    app.post('/register', function (req, res) {
        ...
        if (req.body.password === req.body.confirmPassword) {
            console.log("entrou");
            requestify.put('http://localhost:49445/api/clients', {params: {NumContribuinte: req.body.nib, Nome: req.body.nome, Email: req.body.email, Telefone: req.body.telefone, Morada: req.body.morada, Localidade: req.body.localidade, CodPostal: req.body.codPostal, Password: req.body.password}})
